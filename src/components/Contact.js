    ...
    <div className='container mx-auto'>
      <div className='flex flex-col lg:flex-row'>
        <motion.div variants={fadeIn('right', 0.2)}
          ...
          <div>
          <h4 className='text-x1 uppercase text-accent font-medium mb-2 tracking-wide'>Contáctame</h4>
          <h2 className='text-[45px] uppercase lg:text-[90px] leading-none mb-12'>Trabajemos <br/>juntos!</h2>
          </div>
        </motion.div>
        <motion.form variants={fadeIn('left', 0.2)}
            initial='hidden'
            whileInView={'show'}
            viewport={{once:false, amount:0.3}} className='flex-1 border rounded flex flex-col gap-y-6 pb-24 p-6 items-start'>
          ...
          <input className='bg-transparent border-b py-3 outline-none w-full placeholder:text-white focus:border-accent transition-all' type='text' placeholder='Tu e-mail'></input>
